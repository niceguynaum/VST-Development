...
*/
CFO_FB_Filter::~CFO_FB_Filter(void)
{
...
*/
bool __stdcall CFO_FB_Filter::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CFO_FB_Filter::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CFO_FB_Filter::prepareForPlay()
{
	// Add your code here:
	m_f_z1_left = 0.0;
	m_f_z1_right = 0.0;
...
*/
bool __stdcall CFO_FB_Filter::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CFO_FB_Filter::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CFO_FB_Filter::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CFO_FB_Filter::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CFO_FB_Filter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CFO_FB_Filter::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CFO_FB_Filter::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CFO_FB_Filter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CFO_FB_Filter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CFO_FB_Filter::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CFO_FB_Filter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CFO_FB_Filter::midiClock()
{
...
bool __stdcall CFO_FB_Filter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CFO_FB_Filter::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CFO_FB_Filter::showGUI(void* pInfo)
{
...
bool __stdcall CFO_FB_Filter::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
