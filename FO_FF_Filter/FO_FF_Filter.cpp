...
*/
CFO_FF_Filter::~CFO_FF_Filter(void)
{
...
*/
bool __stdcall CFO_FF_Filter::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CFO_FF_Filter::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CFO_FF_Filter::prepareForPlay()
{
	// Add your code here:
	m_f_z1_left = 0.0;
	m_f_z1_right = 0.0;
...
*/
bool __stdcall CFO_FF_Filter::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	pOutputBuffer[0] = yn * m_fVolume; //changing the audio output based off of the cooked data
...
//
bool __stdcall CFO_FF_Filter::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CFO_FF_Filter::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CFO_FF_Filter::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CFO_FF_Filter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CFO_FF_Filter::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CFO_FF_Filter::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CFO_FF_Filter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CFO_FF_Filter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CFO_FF_Filter::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CFO_FF_Filter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CFO_FF_Filter::midiClock()
{
...
bool __stdcall CFO_FF_Filter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CFO_FF_Filter::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CFO_FF_Filter::showGUI(void* pInfo)
{
...
bool __stdcall CFO_FF_Filter::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui1->m_pUserCookedFloatData = &m_fSlider_a0;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "";
	ui1->cVariableName = "m_fSlider_a0";
	...
	ui2->fUserDisplayDataLoLimit = -96.000000;
	ui2->fUserDisplayDataHiLimit = 0.000000;
	ui2->uUserDataType = floatData;
	ui2->fInitUserIntValue = 0;
	ui2->fInitUserFloatValue = -6.000000;
	ui2->fInitUserDoubleValue = 0;
	ui2->fInitUserUINTValue = 0;
	ui2->m_pUserCookedIntData = NULL;
	ui2->m_pUserCookedFloatData = &m_fVolume_dB;
	ui2->m_pUserCookedDoubleData = NULL;
	ui2->m_pUserCookedUINTData = NULL;
	ui2->cControlUnits = "dB";
	ui2->cVariableName = "m_fVolume_dB";
	ui2->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui2->dPresetData[0] = -6.000000;ui2->dPresetData[1] = 0.000000;ui2->dPresetData[2] = 0.000000;ui2->dPresetData[3] = 0.000000;ui2->dPresetData[4] = 0.000000;ui2->dPresetData[5] = 0.000000;ui2->dPresetData[6] = 0.000000;ui2->dPresetData[7] = 0.000000;ui2->dPresetData[8] = 0.000000;ui2->dPresetData[9] = 0.000000;ui2->dPresetData[10] = 0.000000;ui2->dPresetData[11] = 0.000000;ui2->dPresetData[12] = 0.000000;ui2->dPresetData[13] = 0.000000;ui2->dPresetData[14] = 0.000000;ui2->dPresetData[15] = 0.000000;
	ui2->cControlName = "Volume";
