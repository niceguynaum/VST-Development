...
CVolumeTest::CVolumeTest()
{
	...
	// Cook the raw data:
	m_fVolumeCook = pow(10.0, m_fVolume / 20.0);
...
*/
bool __stdcall CVolumeTest::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CVolumeTest::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CVolumeTest::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CVolumeTest::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// (INSERT Effect)
	pOutputBuffer[0] = pInputBuffer[0]*m_fVolumeCook;

	// Mono-In, Stereo-Out (AUX Effect)
	if(uNumInputChannels == 1 && uNumOutputChannels == 2)
		pOutputBuffer[1] = pInputBuffer[0]*m_fVolumeCook;

	// Stereo-In, Stereo-Out (INSERT Effect)
	if(uNumInputChannels == 2 && uNumOutputChannels == 2)
		pOutputBuffer[1] = pInputBuffer[1]*m_fVolumeCook;
...
//
bool __stdcall CVolumeTest::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CVolumeTest::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CVolumeTest::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CVolumeTest::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CVolumeTest::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CVolumeTest::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CVolumeTest::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CVolumeTest::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CVolumeTest::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CVolumeTest::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CVolumeTest::midiClock()
{
...
bool __stdcall CVolumeTest::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CVolumeTest::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CVolumeTest::showGUI(void* pInfo)
{
...
bool __stdcall CVolumeTest::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
